...
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // per collegare jquary ad dist/app.js


var Handlebars = __webpack_require__(/*! handlebars */ "./node_modules/handlebars/dist/cjs/handlebars.js"); // per collegare handlebars ad dist/app.js
...
$(document).ready(function () {
  // chiamata ajax
  $.ajax({
    "url": "http://localhost/php-ajax-dischi/partials/server.php",
    // colleghiamo il nostro url server alla chiamata ajax
    "method": "GET",
    // impostiamo metodo chiamata
    "success": function success(data) {
      // se la chiamata va a buon fine, esegui la funzione
      render(data);
    },
    "error": function error(err) {
      // se cla chiamata non va a buon fine, manda un errore
      alert("errore");
    }
  ...
  function render(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      console.log(data[i]); // compiliamo il context di handlebars con i vari oggetti da collegare allo script html
      ...
      var html = template(context); // stampiamo la chiamata ajax nel nostro container html
...
__webpack_require__(/*! /home/dom/Scrivania/boolean/esercizi/php-ajax-dischi/src/app.js */"./src/app.js");
module.exports = __webpack_require__(/*! /home/dom/Scrivania/boolean/esercizi/php-ajax-dischi/src/app.scss */"./src/app.scss");
